...
<head>
    ...
    <title>Ejercicio 3 - Unidad 6</title>
</head>
<body>
    <h1>Inserta Libro</h1>
    <div id="contenedor">
        <form action="./controlador/insertar.php" method="post" enctype="multipart/form-data">
            <div class="cajai">
                ...
                <div class="item">
                    <div class="pregunta">
                        <label for="idimagen">Inserta una imagen:
                        </label>
                    </div>
                    <div class="respuesta">
                        <input type="file" name="imagen" id="idimagen" value="<?php if (isset($_POST['paginas'])) echo $_POST['paginas']; ?>" placeholder="Inserta un número">
                        <?php
